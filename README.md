...
- Graybox combat sample with player slash, anchored hitbox movement, contact damage, knockback, HP state, hit pause, active hitbox debug, slime hurtbox, and reset.
